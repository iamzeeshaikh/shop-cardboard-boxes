...
<p>That means die-cut ventilation and hand holes positioned high on the side walls, where they double as airflow without sacrificing the corner posts that carry the stack. Because every one of those cuts removes load-bearing board, a ventilated box needs a higher grade than a plain box of the same dimensions to stack the same. <a href="/product/cardboard-vegetable-packaging-boxes/">Vegetable packing boxes</a> and <a href="/product/cardboard-fruit-packaging-boxes/">fruit trays</a> are specified with that trade-off built in.</p>
...
<p>A water-based dispersion coating handles most of it while keeping the box recyclable in most paper streams. For heavily saturated items, a greaseproof liner performs better and separates cleanly. <a href="/product/cardboard-burger-boxes/">Burger boxes</a>, <a href="/product/cardboard-catering-trays/">catering trays</a> and <a href="/product/cardboard-takeout-box/">takeout boxes</a> are all specified this way, and the <a href="/resources/food-packaging-box-guide/">food packaging guide</a> covers the barrier options.</p>`,
    },
    {
...
<p><a href="/product/cardboard-seafood-packaging-boxes/">Seafood packaging</a> and <a href="/product/cardboard-insulated-cold-boxes/">insulated cold boxes</a> pair a moisture barrier with an insulating liner, and the coolant is sized to the route rather than to the box. For citrus and produce, ventilation matters more than insulation — see <a href="/product/cardboard-fruit-packaging-boxes/">fruit packaging boxes</a>.</p>`,
    },
    {
...
<p>For accessories and jewellery, <a href="/product/cardboard-ring-boxes/">small rigid boxes</a> and <a href="/product/cardboard-boxes-for-jewellery/">jewellery boxes</a> with fitted inserts do the presentation work.</p>`,
    },
    {
...
<p>See <a href="/product/cardboard-bakery-boxes/">bakery boxes</a> and <a href="/product/cardboard-pastry-boxes/">pastry boxes</a>, and the <a href="/resources/food-packaging-box-guide/">food packaging guide</a> for barrier options.</p>`,
    },
    {
      h2: 'What we are not',
...
<p><a href="/product/cardboard-corrugated-pallet-boxes/">Corrugated pallet boxes</a> and <a href="/product/double-wall-cardboard-boxes/">double wall boxes</a> cover most of this work.</p>`,
    },
    {
...
<p>That points at offset lithography rather than digital, because spot colour and small type reproduce identically across runs. It also points at a board with a reliable white surface — <a href="/resources/cardboard-packaging-materials/">SBS or coated recycled board</a> rather than kraft. See <a href="/product/cardboard-pill-packaging-boxes/">pill packaging boxes</a> and <a href="/product/cardboard-medical-device-packaging/">medical device packaging</a>.</p>`,
    },
    {
...
<p><a href="/resources/reduce-packaging-and-shipping-costs/">The cost guide</a> works through both, and <a href="/product-category/wholesale-cardboard-boxes/">wholesale ordering</a> sets out where the breaks fall.</p>`,
    },
  ],
